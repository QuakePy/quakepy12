...
class Amplitude(QPCore.QPPublicObject):
    ...
    addElements = QPElement.QPElementList((
        QPElement.QPElement('publicID', 'publicID', 'attribute', unicode, 'basic'),
            ...
            QPElement.QPElement('genericAmplitude', 'genericAmplitude', 'element', RealQuantity.RealQuantity, 'complex'),
        ...
        QPElement.QPElement('unit', 'unit', 'element', unicode, 'enum'),
            ...
            QPElement.QPElement('period', 'period', 'element', RealQuantity.RealQuantity, 'complex'),
        QPElement.QPElement('snr', 'snr', 'element', float, 'basic'),

            QPElement.QPElement('timeWindow', 'timeWindow', 'element', TimeWindow.TimeWindow, 'complex'),

            QPElement.QPElement('pickID', 'pickID', 'element', unicode, 'basic'),

            QPElement.QPElement('waveformID', 'waveformID', 'element', WaveformStreamID.WaveformStreamID, 'complex'),

            QPElement.QPElement('filterID', 'filterID', 'element', unicode, 'basic'),

            QPElement.QPElement('scalingTime', 'scalingTime', 'element', TimeQuantity.TimeQuantity, 'complex'),
        QPElement.QPElement('magnitudeHint', 'magnitudeHint', 'element', unicode, 'basic'),
