...
class Reading(QPCore.QPPublicObject):
    """
    QuakePy: Reading
    """
    ...
    # <!-- UML2Py start -->
    addElements = QPCore.QPElementList((
        QPCore.QPElement('publicID', 'publicID', 'attribute', unicode, 'basic'),
        QPCore.QPElement('pickReference', 'pickReference', 'element', ResourceReference, 'multiple'),
        QPCore.QPElement('amplitudeReference', 'amplitudeReference', 'element', ResourceReference, 'multiple'),
    ))
    # <!-- UML2Py end -->
    def __init__(self, publicID=None, **kwargs):
        super(Reading, self).__init__(publicID, **kwargs)
