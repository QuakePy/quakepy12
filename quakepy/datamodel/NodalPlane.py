...
class NodalPlane(QPCore.QPPublicObject):
    ...
    addElements = QPElement.QPElementList((
            ...
            QPElement.QPElement('strike', 'strike', 'element', RealQuantity.RealQuantity, 'complex'),

            QPElement.QPElement('dip', 'dip', 'element', RealQuantity.RealQuantity, 'complex'),

            QPElement.QPElement('rake', 'rake', 'element', RealQuantity.RealQuantity, 'complex'),
    ))
    # <!-- UML2Py end -->
    def __init__(self, 
        strike=None,
