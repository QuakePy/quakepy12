...
class Pick(QPCore.QPPublicObject):
    ...
    addElements = QPElement.QPElementList((
        QPElement.QPElement('publicID', 'publicID', 'attribute', unicode, 'basic'),
            ...
            QPElement.QPElement('horizontalSlowness', 'horizontalSlowness', 'element', RealQuantity.RealQuantity, 'complex'),

            QPElement.QPElement('backazimuth', 'backazimuth', 'element', RealQuantity.RealQuantity, 'complex'),

            QPElement.QPElement('slownessMethodID', 'slownessMethodID', 'element', unicode, 'basic'),
        QPElement.QPElement('onset', 'onset', 'element', unicode, 'enum'),

            QPElement.QPElement('phaseHint', 'phaseHint', 'element', Phase.Phase, 'complex'),
        QPElement.QPElement('polarity', 'polarity', 'element', unicode, 'enum'),
